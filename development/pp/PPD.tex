...
\section{Schedule}
	...
	\subsection{Global}
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.675]{./Images/0-GlobalGantt.pdf} 
		\end{figure}
		\end{landscape}
	\subsection{RASD}
		\begin{figure}[H]
	...
	\subsection{First release}
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.725]{./Images/5-FirstReleaseGantt.pdf} 
		\end{figure}
		\end{landscape}
		\begin{landscape}
	\subsection{Second release}
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.725]{./Images/6-SecondReleaseGantt.pdf} 
		\end{figure}
		\end{landscape}
		\begin{landscape}
	\subsection{Third release}
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.55]{./Images/7-ThirdReleaseGantt.pdf} 
		\end{figure}
		\end{landscape}
