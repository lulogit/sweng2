...
We have identified Actors and situations that can be useful to manage the system.
	...
	\subsubsection{Power Plug}
		A \powerplug is the station that charge the battery of an electric car. All \powerplug are displayed in the map on-board \powerenjoy cars. Each \powerplug is in a \safearea. A \powerenjoyuser who plugs his car into a \powerplug receives the discount expected within \powerenjoy rules.
	\subsubsection{Power Plug Slot}
		A \powerplugslot is a parking that can contain only 1 car annexed to a \powerplug. Each car parked here is charging.
