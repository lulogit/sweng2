...
\subsubsection{Maintain Car}
	...
	\subsection*{Note}
		This class diagram shows the the principal objects of the world that we are describing. We consider the world in a certain instant. So we modelled the Rent and reservation Classes as current rent and reservation, not considering the previous ones. 
...
Stated Goals, Domain Assumptions and Requirements, we would like to define the boundary of the hardware and external software systems that will be involved in our project.
...
\subsection{Cars}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.11]{auto.pdf}% "%" necessario
		\caption{Car sensors and hardware overview}
	\end{figure}
	...
	\begin{itemize}
		...
		\item Cars periodically notify the system of their position, in case of accident / failure the notification process stops and an emergency is reported to the emergency staff.
