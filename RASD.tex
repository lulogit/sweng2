...
\section{Specific Requirements}
	...
	\begin{requirementsgroup}
		 ...
		 \req { to enable the money saving option, thus be shown information about where to park the car (near to an entered destination) in order to get the discount described above [\reqref{20}]. }
